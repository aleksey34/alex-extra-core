...
use AlexExtraCore\App\Elementor\Controls\CustomControl1;
use AlexExtraCore\App\Elementor\Controls\CustomControl2;
use AlexExtraCore\App\Elementor\Controls\EmojiOneAreaControl;
 ...
 * @since 1.0.0
 *
 * require classes  with autoload composer
 */
...
final class Elementor {
	...
	public function register_controls( $controls_manager ) {
		...
		$controls_manager->register( new CustomControl1() );
		$controls_manager->register( new CustomControl2() );
		$controls_manager->register( new EmojiOneAreaControl() );
