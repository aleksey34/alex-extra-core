...
//	    var_dump(parent::get_script_depends());
...
//        return ['swiper'];
	...
	protected function render() {
	    ...
	    $this->getJs($alex_swiper_wrapper_id);
	...
	private function getJs($wrapper_id){

	    ?>
<script>
    jQuery(function (){
        const swiper = new Swiper('#<?php echo esc_attr($wrapper_id) ; ?>', {
            // Optional parameters
