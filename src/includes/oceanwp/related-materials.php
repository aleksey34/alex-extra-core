<?php
/**
 * connect related-materials to single material
 *
 */
...
// Only display for MATERIAL posts.
		if ( 'material' !== get_post_type() ||  is_post_type_archive( 'material' ) || is_archive()  ) {
                    ...
                    <article <?php post_class( $classes ); ?>>
                        ...
                        elseif ( has_post_thumbnail() ) :
                            ...
                            <figure class="related-post-media clr">
                                ...
                                <a href="<?php the_permalink($related_current_id); ?>" class="related-thumb">
									...
									// Images attr.
									$img_id  = get_post_thumbnail_id( $related_current_id, 'full' );
									...
									if ( OCEAN_EXTRA_ACTIVE
										...
										$srpfe_img_alt = get_post_meta( get_post_thumbnail_id( $related_current_id ), '_wp_attachment_image_alt', true);
                        ...
                        <h3 class="related-post-title">
                            <a href="<?php   the_permalink( $related_current_id ); ?>" rel="bookmark"><?php echo get_the_title($related_current_id); ?></a>
                        </h3><!-- .related-post-title -->

						<?php if ( true === $srp_date ) { ?>
                            <time class="published" datetime="<?php echo esc_html( get_the_date( 'c' , $related_current_id ) ); ?>"><?php oceanwp_icon( 'date' ); ?><?php echo esc_html( get_the_date('' , $related_current_id) ); ?></time>
						<?php } ?>
