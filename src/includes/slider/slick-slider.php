...
//	if(is_single()  && 'gallery' === get_post_format()) :
	...
	<script>
        jQuery(document).ready(function(){
            ...
            // for gutenberg!
            const gutenbergTopBlock = jQuery('.alex-gutenberg-slick-slider ul.slider-img');
            const gutenbergDownBlock = jQuery('.alex-gutenberg-slick-slider ul.slider-nav');

            if(gutenbergTopBlock && gutenbergTopBlock.length
                && gutenbergDownBlock && gutenbergDownBlock.length){
